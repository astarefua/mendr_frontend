...
//   String? role; // <-- New: stores the incoming role
...
//   @override
//   Widget build(BuildContext context) {
//     // Get the role from navigation arguments (only if not already set)
...
//     const SnackBar(content: Text("User ID missing in token.")),
//   );
//   return; // Prevent navigating without a valid ID
// }
...
//             Navigator.pushReplacementNamed(context, '/home/patient');
//             print("Navigating to PatientHomeScreen...");
